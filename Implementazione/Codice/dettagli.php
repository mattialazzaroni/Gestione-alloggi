            ...
            if (isset($_POST['riserva'])) {
                ...
                if (isset($_SESSION["utente"])) {
                    ...
                    group by (riservazione.id_camera)) as get_id where rownumber = " . $id_camera . "";
                            ...
                            <p style='color:green'>La riservazione della camera, " . $camera_scelta . " dal " . $_SESSION['checkin'] . " al " . $_SESSION['checkout'] . ", per " . $_SESSION['adulti'] . " adulti/o e per " . $_SESSION['bambini'] . " bambini/o &egrave; stata aggiunta con successo. Controlla la tua email se vuoi stampare la riservazione.</p>
                            </div>";

                            //Preparo il body dell'email.
                            unset($body);
                            $body = "Hai riservato la camera " . $camera_scelta . ", dal " . $_SESSION['checkin'] . " al " . $_SESSION['checkout'] . ", per " . $_SESSION['adulti'] . " adulti/o e per " . $_SESSION['bambini'] . " bambini/o.";
                    ...
                    //Se è stata trovata una sola camera. 
                        ...
                        $_SESSION['message'] = "<br><div class='text-success text-center'>
                            <p style='color:green'>La riservazione della camera " . $_SESSION['camera_scelta'] . ", dal " . $_SESSION['checkin'] . " al " . $_SESSION['checkout'] . ", per " . $_SESSION['adulti'] . " adulti/o e per " . $_SESSION['bambini'] . " bambini/o &egrave; stata aggiunta con successo. Controlla la tua email se vuoi stampare la riservazione.</p>
                            </div>";

                        //Preparo il body dell'email.
                        unset($body);
                        $body = "Hai riservato la camera " . $_SESSION['camera_scelta'] . ", dal " . $_SESSION['checkin'] . " al " . $_SESSION['checkout'] . ", per " . $_SESSION['adulti'] . " adulti/o e per " . $_SESSION['bambini'] . " bambini/o.";
                        $allegato = "<br>In allegato è possibile trovare un pdf da stampare.";
                        $mail->Body = $body . $allegato;
